import { IonButton, IonButtons, IonContent, IonIcon, IonItem, IonPage, IonText, IonTitle, IonToolbar } from "@ionic/react";
import "./Choice.css";
        ...
        <IonPage>
            ...
            <IonContent className="choices background-image">
                ...
                <div className='buttons-div'>
                    <IonButton class="round ion-text-wrap" className="big-button saved-lists">
                        <img className="button-img" src={headerImg} />
                        <IonText className="big-button-text">
                            Shop one of my saved Grocery Lists
                        </IonText>
                    </IonButton>
                    <IonButton class="round ion-text-wrap" className="big-button new-list">
                        <img className="button-img" src={headerImg} />
                        <IonText className="big-button-text">
                            Shop a new List
                        </IonText>
