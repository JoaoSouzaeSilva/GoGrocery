...
const SignInComponent = () => {
  ...
  function checkPassword() {
    if (password != JSON.parse(localStorage.getItem(email)!).password)
      return false;
    else return true;
  }
    ...
    <>
      <IonList className="sign-in-list">
        <IonItem fill="outline" className="sign-in-label">
          <IonLabel className="labelfix" position="floating">
            Email
          </IonLabel>
          <IonInput
            type="email"
        ...
        <IonItem fill="outline" className="sign-in-label">
          <IonLabel background-color={"danger"} position="floating">
            Password
          </IonLabel>
          <IonInput
      ...
      <IonButton className="forgotPWD" size="small" fill="clear">
      ...
      <div className="btn-container">
        <IonButton
          ...
          expand="block"
          fill="solid"
          className="ion-buttons-signin ion-item-email-pwd"
        >
          Sign In
        </IonButton>
        <IonButton
